...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://job-finde-server-lake.vercel.app/jobs/${params.id}`)
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(` https://job-finde-server-lake.vercel.app/JobByEmail/${params.id}`)
            },
