...
const BidRequest = () => {
    ...
    useEffect(() => {
        fetch("https://job-finde-server-lake.vercel.app/bookings")
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleAccept = (bookingId) => {
        fetch(`https://job-finder-server-lake.vercel.app/bookings/${bookingId}/accept`, {
            method: "PUT",
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleReject = (bookingId) => {
        fetch(`https://job-finde-server-lake.vercel.app/bookings/${bookingId}/reject`, {
            method: "PUT",
        })
            .then((res) => res.json())
            .then((data) => {
